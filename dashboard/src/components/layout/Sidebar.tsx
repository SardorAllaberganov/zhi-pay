...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/compliance/kyc-tiers', labelKey: 'admin.nav.kyc-tiers', icon: Layers },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/content/news', labelKey: 'admin.nav.news', icon: Newspaper },
      { to: '/content/notifications', labelKey: 'admin.nav.notifications', icon: Bell },
    ],
  },
];
