...
const EN: Record<string, string> = {
  ...
  // ────────────────────────────────────────────────────────────────────
  // Settings (Phase 21) — /settings · 5 tabs
  // ────────────────────────────────────────────────────────────────────

  // Page chrome
  'admin.settings.title': 'Settings',
  'admin.settings.subtitle': 'Manage your admin account, security, and preferences.',
  'admin.settings.tab.profile': 'Profile',
  'admin.settings.tab.security': 'Security',
  'admin.settings.tab.sessions': 'Sessions',
  'admin.settings.tab.preferences': 'Preferences',
  'admin.settings.tab.my-audit': 'My audit',

  // Profile tab
  'admin.settings.profile.identity': 'Identity',
  'admin.settings.profile.field.full-name': 'Full name',
  'admin.settings.profile.field.email': 'Email',
  'admin.settings.profile.field.email.managed': 'Managed out-of-band',
  'admin.settings.profile.field.phone': 'Phone',
  'admin.settings.profile.field.phone.hint': 'Used for emergency contact only — never for sign-in.',
  'admin.settings.profile.field.role': 'Role',
  'admin.settings.profile.field.created-at': 'Member since',
  'admin.settings.profile.action.save': 'Save changes',
  'admin.settings.profile.avatar.change': 'Change avatar',
  'admin.settings.profile.avatar.tooltip': 'Avatars are derived from initials. Photo uploads are not available in v1.',
  'admin.settings.profile.confirm.title': 'Save profile changes?',
  'admin.settings.profile.confirm.body': 'Profile changes are logged. Provide a short reason so other admins can audit the change.',
  'admin.settings.profile.confirm.reason-required': 'Please provide a reason of at least 10 characters.',
  'admin.settings.profile.confirm.reason-label': 'Reason for change',
  'admin.settings.profile.confirm.reason-placeholder': 'e.g. Legal name update after marriage; correcting a typo; etc.',
  'admin.settings.profile.confirm.reason-hint': 'characters',
  'admin.settings.profile.confirm.submit': 'Save changes',
  'admin.settings.profile.toast.saved': 'Profile updated.',
  'admin.settings.profile.toast.no-changes': 'Nothing to save — no fields changed.',
  'admin.settings.profile.toast.error': "Couldn't save profile. Please try again.",

  // Security tab — Password card
  'admin.settings.security.password.title': 'Password',
  'admin.settings.security.password.last-changed': 'Last changed',
  'admin.settings.security.password.never-changed': "You haven't changed your password yet.",
  'admin.settings.security.password.stale-warning': 'rotate it now',
  'admin.settings.security.password.change': 'Change password',
  'admin.settings.security.password.modal.title': 'Change password',
  'admin.settings.security.password.modal.body': 'Enter your current password and choose a new one. The new password must meet all requirements below.',
  'admin.settings.security.password.field.current': 'Current password',
  'admin.settings.security.password.field.new': 'New password',
  'admin.settings.security.password.field.confirm': 'Confirm new password',
  'admin.settings.security.password.field.confirm.mismatch': "Passwords don't match.",
  'admin.settings.security.password.action.submit': 'Change password',
  'admin.settings.security.password.confirm.title': 'Change password?',
  'admin.settings.security.password.confirm.signs-out': 'You will be signed out of all other sessions.',
  'admin.settings.security.password.confirm.submit': 'Change password',
  'admin.settings.security.password.toast.changed': 'Password updated.',
  'admin.settings.security.password.toast.changed-with-revoke': 'Password updated. {n} other sessions signed out.',
  'admin.settings.security.password.toast.wrong-current': 'Current password is incorrect.',
  'admin.settings.security.password.toast.invalid-new': "New password doesn't meet requirements.",
  'admin.settings.security.password.toast.error': "Couldn't change password. Please try again.",
  'admin.settings.security.password.rule.length': 'At least 12 characters',
  'admin.settings.security.password.rule.mixed-case': 'Upper- and lower-case letters',
  'admin.settings.security.password.rule.number': 'At least one number',
  'admin.settings.security.password.rule.symbol': 'At least one symbol',

  // Security tab — Recovery card
  'admin.settings.security.recovery.title': 'Recovery contact',
  'admin.settings.security.recovery.unavailable': 'Self-service recovery is not available in v1. To recover access to a locked-out account, contact a super-admin out-of-band.',
  'admin.settings.security.recovery.contact-label': 'Out-of-band contact:',

  // Sessions tab — Active list
  'admin.settings.sessions.active.title': 'Active sessions',
  'admin.settings.sessions.active.subtitle.one': 'Just this device.',
  'admin.settings.sessions.active.subtitle.many': '{n} active sessions across your devices.',
  'admin.settings.sessions.active.this-device': 'This device',
  'admin.settings.sessions.active.action.revoke': 'Revoke',
  'admin.settings.sessions.active.action.revoke-all': 'Revoke all other sessions',
  'admin.settings.sessions.active.confirm.revoke-all': "Sign out of {n} other devices? You'll stay signed in here.",
  'admin.settings.sessions.column.device': 'Device',
  'admin.settings.sessions.column.ip': 'IP',
  'admin.settings.sessions.column.signed-in': 'Signed in',
  'admin.settings.sessions.column.last-activity': 'Last activity',
  'admin.settings.sessions.column.actions': 'Actions',
  'admin.settings.sessions.revoke.title': 'Revoke this session?',
  'admin.settings.sessions.revoke.body': 'The other device will be signed out at next request.',
  'admin.settings.sessions.revoke-all.title': 'Sign out of all other devices?',
  'admin.settings.sessions.toast.revoked': 'Session revoked.',
  'admin.settings.sessions.toast.revoked-all': '{n} sessions revoked.',
  'admin.settings.sessions.toast.error': "Couldn't revoke session. Please try again.",

  // Sessions tab — Sign-in history
  'admin.settings.sessions.history.title': 'Sign-in history',
  'admin.settings.sessions.history.subtitle': 'Last {n} sign-in attempts on your account.',
  'admin.settings.sessions.history.column.outcome': 'Outcome',
  'admin.settings.sessions.history.column.when': 'When',
  'admin.settings.sessions.history.column.ip': 'IP',
  'admin.settings.sessions.history.column.device': 'Device',
  'admin.settings.sessions.history.outcome.success': 'Success',
  'admin.settings.sessions.history.outcome.failed': 'Failed',
  'admin.settings.sessions.history.view-full': 'View full history in audit log',

  // Preferences tab — Display card
  'admin.settings.preferences.display.title': 'Display',
  'admin.settings.preferences.display.theme': 'Theme',
  'admin.settings.preferences.display.theme.light': 'Light',
  'admin.settings.preferences.display.theme.dark': 'Dark',
  'admin.settings.preferences.display.theme.system': 'System',
  'admin.settings.preferences.display.language': 'Language',
  'admin.settings.preferences.display.language.coming-soon': 'Coming soon',
  'admin.settings.preferences.display.density': 'Density',
  'admin.settings.preferences.display.density.hint': 'Compact is the admin default. Comfortable adds 4px to row heights across every table.',
  'admin.settings.preferences.display.density.compact': 'Compact',
  'admin.settings.preferences.display.density.comfortable': 'Comfortable',
  'admin.settings.preferences.display.tabular-numerals': 'Tabular numerals',
  'admin.settings.preferences.display.tabular-numerals.hint': 'Aligns digits in monospace columns — useful for currency and ID columns.',

  // Preferences tab — Locale card
  'admin.settings.preferences.locale.title': 'Time & locale',
  'admin.settings.preferences.locale.timezone': 'Time zone',
  'admin.settings.preferences.locale.timezone.hint': 'Defaults to your browser-detected zone.',
  'admin.settings.preferences.locale.date-format': 'Date format',
  'admin.settings.preferences.locale.time-format': 'Time format',
  'admin.settings.preferences.locale.time-format.12h': '12-hour',
  'admin.settings.preferences.locale.time-format.24h': '24-hour',
  'admin.settings.preferences.locale.rollout-note': 'Date and time format preferences are saved. Full rollout to date and time displays across the app is coming next phase — formats apply to Sessions and sign-in history within Settings today.',

  // Preferences tab — Notifications card
  'admin.settings.preferences.notifications.title': 'Notifications',
  'admin.settings.preferences.notifications.subtitle': 'Which admin events trigger an email or push to your account.',
  'admin.settings.preferences.notifications.aml-critical': 'Critical AML flag opened',
  'admin.settings.preferences.notifications.aml-critical.hint': 'Notify me when an AML flag with critical severity opens.',
  'admin.settings.preferences.notifications.sanctions': 'Sanctions hit detected',
  'admin.settings.preferences.notifications.sanctions.hint': 'Notify me on every sanctions screening hit, regardless of severity.',
  'admin.settings.preferences.notifications.service-offline': 'Service goes offline',
  'admin.settings.preferences.notifications.service-offline.hint': 'Notify me when a payment provider or KYC service health check fails.',
  'admin.settings.preferences.notifications.fx-stale': 'FX rate goes stale',
  'admin.settings.preferences.notifications.fx-stale.hint': 'Notify me when the locked FX rate has been valid for too long.',
  'admin.settings.preferences.notifications.daily-digest': 'Daily ops summary',
  'admin.settings.preferences.notifications.daily-digest.hint': 'Once a day, an email summary of overnight activity.',
  'admin.settings.preferences.notifications.failed-sign-in': 'Failed sign-in to my account',
  'admin.settings.preferences.notifications.failed-sign-in.hint': 'Notify me when someone fails sign-in to my account from a new IP.',

  // My audit tab
  'admin.settings.my-audit.title': 'Recent activity',
  'admin.settings.my-audit.subtitle': "Entity-state-change actions you've taken across the dashboard. Sign-in and identity events live in the audit-log of your account.",
  'admin.settings.my-audit.stats': 'Your activity',
  'admin.settings.my-audit.stats.in-24h': 'in the last 24h',
  'admin.settings.my-audit.stats.in-7d': 'in the last 7 days',
  'admin.settings.my-audit.open-full': 'Open in audit log',
